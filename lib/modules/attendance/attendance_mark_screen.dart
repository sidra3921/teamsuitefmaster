  ...
  Future<void> _loadTodayAttendance() async {
    ...
    try {
      ...
      if (mounted && result['success']) {
        ...
        setState(() {
          _isCheckedIn = data['check_in'] != null && data['check_out'] == null;
          _checkInTime = data['check_in'] != null ? TimeOfDay.now() : null;
          _checkOutTime = data['check_out'] != null ? TimeOfDay.now() : null;
